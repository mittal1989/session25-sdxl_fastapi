...
MODEL_SERVER_URL = os.environ.get("MODEL_SERVER_URL", "http://model-server-service:8080")
...
async def lifespan(app: FastAPI):
    ...
    s3_client = boto3.client(
        ...
        aws_access_key_id="AKIA2VWS7UCA5DVOXYHO", 
        aws_secret_access_key="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"
    )
